...
print(f"el valor d la capacitancia Cr es de {Cr} faradios.\n")
print(f"el valor d la resistencia Re es de {Re} Ohms.\n")
print(f"el valor d la resistencia Rr es de {Rr} Ohms.\n")
print(f"el valor d la capacitancia Ce es de {Ce} faradios.\n")
print(f"funcion de transferencia del controlador PID es de {PID}\n")
